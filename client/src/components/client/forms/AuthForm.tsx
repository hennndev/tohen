...
const authForm = ({handleClose, isLogin, changeAuth}: PropsTypes) => {
    ...
    return (
        <form onSubmit={handleSubmit(onSubmit)} className='flex flex-col space-y-1.5 text-[#333] dark:text-gray-200'>
            ...
            <section className="flex md:items-center flex-col md:flex-row flex-1 space-x-2">
                {!isLogin && (
            ...
            <section className="flex md:items-center flex-col md:flex-row flex-1 space-x-3">
                <section className='flex flex-1 flex-col space-y-1'>
            ...
            <section className="flexx space-x-3 !mt-3">
                <Button disabled={isLoading} type="submit">
                    {isLoading && <LuLoader2 className='animate-spin mr-2 w-4 h-4'/>} Submit
                </Button>
